...
DATABASES = {
    'default': {
        ...
        'NAME': 'codekeen',
        'USER': 'admin',
        'PASSWORD': 'Jeeva12345678910',
        'HOST': 'database.cryw2640yuyg.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
        'OPTIONS': {
            'ssl': {
                'ca': os.path.join(BASE_DIR, 'us-east-1-bundle.pem')
            }
        }
    }
}
